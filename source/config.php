...
define('DB_NAME', isset($env_array['DB_NAME']) ? $env_array['DB_NAME'] : 'omarkahouach');
define('DB_USERNAME', isset($env_array['DB_USERNAME']) ? $env_array['DB_USERNAME'] : 'omar');
define('DB_PASSWORD', isset($env_array['DB_PASSWORD']) ? $env_array['DB_PASSWORD'] : 'khaled');
?>
